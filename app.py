...
won = image.load('other_assets/won.png')
...
while running:
    ...
    if total_skipped == len(tiles):
        won = pygame.transform.scale(won,(512,512))
        screen.blit(won,(0, 0))
        display.flip()
        sleep(1.0)
        font = pygame.font.Font('freesansbold.ttf', 32) 
        screen.blit(font.render("Total number of clicks is {0}".format(count), True, (0, 255, 0),(0,0,128)), (32, 210))
        display.flip()
        sleep(1.0)
        running = False
